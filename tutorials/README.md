...
| [nemo-retriever-synthetic-data-generation](./nemo_retriever_synthetic_data_generation) | Demonstrates the use of NeMo Curator synthetic data generation modules to leverage [Mixtral-8x22b Instruct](https://build.nvidia.com/mistralai/mixtral-8x22b-instruct) for generating synthetic data and perform data quality assesement on generated data using [Llama3-70b Instruct](https://build.nvidia.com/meta/llama3-70b) as judge LLM and [NV-EmbedQA-E5-v5](https://build.nvidia.com/nvidia/nv-embedqa-e5-v5) as judge embedding model. The generated data would be used to evaluate retrieval/RAG pipelines |
