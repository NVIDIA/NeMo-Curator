...
from docbuilder import TedTalksExtractor, TedTalksIterator


def write_jsonl(input_filename: str, output_dir: str, dump_every_n: int = 10000, force=False):
    """
    ...
    if os.path.isdir(output_dir):
        if len(os.listdir(output_dir)) > 0 and force is False:
            print(
    ...
    iterator = TedTalksIterator()
    extractor = TedTalksExtractor()
    to_dump = []
    dump_ctr = 0
