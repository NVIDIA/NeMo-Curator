...
* `codegen_DAPT\llm_data_collection` contains playbooks and scripts for DAPT data curation
* `codegen_DAPT\pdfcleaner` contains library and scripts need to convert pdfs to txt files

* Playbook for data curation with NeMo Curator: `codegen_DAPT\llm_data_collection\notebooks\data_curation-nemo-curator_DAPT.ipynb`
