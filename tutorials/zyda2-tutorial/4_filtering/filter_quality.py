...
if __name__ == '__main__':
    ...
    parser.add_argument("--quality_pred", type=str, required=True, choices={"High", "Medium", "Low"}, help="Quality for filtering")
    ...
    ddf_filtered = ddf[ddf["quality_pred"] == args.quality_pred].repartition(partition_size="512MB")
    ddf_filtered.to_parquet(args.output, write_index=False, overwrite=True, schema={"quality_prob": pa.list_(pa.float32())})
