...
class ArgumentHelper:
    ...
    def add_builder_config_file(self):
        self.parser.add_argument(
            "--builder-config-file",
            type=str,
            required=True,
    ...
    def add_bucket_mapping_ddf_blocksize(self):
        self.parser.add_argument(
    ...
    def add_bucket_parts_per_worker(self):
        self.parser.add_argument(
    ...
    def add_buckets_per_shuffle(self):
        self.parser.add_argument(
            "--buckets-per-shuffle",
            type=int,
            required=True,
    ...
    def add_common_crawl_args(self):
        self.parser.add_argument(
    ...
    def add_create_dask_cluster_args(self):
        self.parser.add_argument(
            "-n",
            "--name",
            type=str,
    ...
    def add_enable_spilling(self):
        self.parser.add_argument("--enable-spilling", action="store_true")

    def add_filter_config_file(self):
        self.parser.add_argument(
            "--filter-config-file",
            type=str,
            required=True,
    ...
    def add_jaccard_pairs_path(self):
        self.parser.add_argument(
            "--jaccard-pairs-path",
            type=str,
    ...
    def add_jaccard_threshold(self):
        self.parser.add_argument(
            "--jaccard-threshold",
            type=int,
            default=0.8,
    ...
    def add_keep_downloaded_files(self):
        ArgumentHelper.__attach_bool_arg(
            self.parser,
    ...
    def add_keep_node_scores_tmp_dir(self):
        ArgumentHelper.__attach_bool_arg(
            self.parser,
    ...
    def add_language(self, help: str):
        self.parser.add_argument(
            "--language",
            type=str,
            default="en",
    ...
    def add_log_dir(self, default: str = "./log/filter_docs"):
        self.parser.add_argument(
            "--log-dir",
            type=str,
            default=default,
    ...
    def add_input_bucket_field(self):
        self.parser.add_argument(
            "--input-bucket-field",
            type=str,
            default="_bucket_id",
    ...
    def add_input_bucket_mapping_dir(self):
        self.parser.add_argument(
    ...
    def add_input_local_data_dir(self):
        self.parser.add_argument(
    ...
    def add_input_matched_ngrams(self):
        self.parser.add_argument(
    ...
    def add_input_metadata_field(self):
        self.parser.add_argument(
    ...
    def add_input_task_ngrams(self):
        self.parser.add_argument(
            "--input-task-ngrams",
            type=str,
            default=None,
    ...
    def add_max_document_splits(self):
        self.parser.add_argument(
            "--max-document-splits",
            type=int,
            default=10,
    ...
    def add_output_bucket_dir(self):
        self.parser.add_argument(
            "--output-bucket-dir",
            type=str,
            required=True,
    ...
    def add_output_data_dir(self, help: str):
        self.parser.add_argument(
            "--output-data-dir",
            type=str,
            required=True,
    ...
    def add_output_document_score_dir(self):
        self.parser.add_argument(
    ...
    def add_output_download_dir(self):
        self.parser.add_argument(
            "--output-download-dir",
            type=str,
            default=None,
    ...
    def add_output_matched_ngram_data(self):
        self.parser.add_argument(
    ...
    def add_output_metadata_distribution(self):
        self.parser.add_argument(
    ...
    def add_output_minhash_dir(self):
        self.parser.add_argument(
            "--output-minhash-dir",
            type=str,
            required=True,
    ...
    def add_output_removed_doc_dir(self):
        self.parser.add_argument(
    ...
    def add_output_removed_document_dir(self):
        self.parser.add_argument(
    ...
    def add_output_resharded_dir(self):
        self.parser.add_argument(
    ...
    def add_output_retained_document_dir(self):
        self.parser.add_argument(
    ...
    def add_output_task_deduped_dir(self):
        self.parser.add_argument(
    ...
    def add_output_train_file(self, help: str, default: str = None):
        self.parser.add_argument(
            "--output-train-file",
            type=str,
            default=default,
    ...
    def add_overwrite_existing_json(self):
        ArgumentHelper.__attach_bool_arg(
            self.parser,
    ...
    def add_prepare_task_data_args(self):
        self.parser.add_argument(
            "--task-config-file",
            type=str,
            default=None,
    ...
    def add_remove_metadata_field(self):
        ArgumentHelper.__attach_bool_arg(
            self.parser,
    ...
    def add_scheduler_address(self):
        self.parser.add_argument(
            "--scheduler-address",
            type=str,
            default=None,
    ...
    def add_set_torch_to_use_rmm(self):
        self.parser.add_argument("--set-torch-to-use-rmm", action="store_true")

    def add_shuffle(self, help: str):
        ArgumentHelper.__attach_bool_arg(
            "shuffle",
            help=help,
        )

    def add_shuffle_type(self):
        self.parser.add_argument(
            "--shuffle-type",
            type=str,
            default="tasks",
    ...
    def add_shuffled_docs_path(self):
        self.parser.add_argument(
            "--shuffled-docs-path",
            type=str,
    ...
    def add_supported_entities(self):
        self.parser.add_argument(
            "--supported-entities",
            type=str,
            default=None,
    ...
    def add_text_ddf_blocksize(self):
        self.parser.add_argument(
            "--text-ddf-blocksize",
            type=int,
            default=256,
    ...
    def add_train_fasttext_args(self):
        self.add_seed(default=1992)
        self.parser.add_argument(
            "--fasttext-files-dir",
            type=str,
            default=None,
    ...
    def add_verify_classification_args(self):
        self.parser.add_argument(
            "--results_file_path",
            type=str,
            required=True,
    ...
    def add_wikipedia_args(self):
        self.add_language(help="Desired language of the Wikipedia dump")
        self.parser.add_argument(
