...
def get_news_warc_paths(
  ...
  if beg.year < 2016 or end.year > today.year:
    print("Warning: WARC paths exist only from 2016-8 to "
...
def get_common_crawl_urls(starting_snapshot: str, ending_snapshot: str, data_domain_prefix="https://data.commoncrawl.org", index_prefix="https://index.commoncrawl.org", news=False) -> List[str]:
    """
...
def get_wikipedia_urls(language="en", wikidumps_index_prefix="https://dumps.wikimedia.org", dump_date: Optional[str]=None) -> List[str]:
    """
