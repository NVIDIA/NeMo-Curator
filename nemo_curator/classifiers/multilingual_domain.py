...
class MultilingualDomainModelConfig:
    model: str = "microsoft/mdeberta-v3-base"
    fc_dropout: float = 0.2
    max_len: int = 512


class MultilingualDomainModel(HFModel):
    def __init__(
        self,
...
class MultilingualDomainClassifier(DistributedDataClassifier):
    """
    MultilingualDomainClassifier is a specialized classifier designed for domain classification tasks in 52 languages.
