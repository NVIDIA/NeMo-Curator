...
class TestAsyncNemotronGenerator:
    ...
    @pytest.mark.asyncio
    async def test_convert_response_to_yaml_list(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_convert_response_to_yaml_list_invalid_yaml(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_convert_response_with_non_string_elements(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_try_convert_yaml_list(self, mock_llm_client: AsyncMock) -> None:
        ...
        result = await generator._try_convert_yaml_list(  # noqa: SLF001
        ...
        mock_llm_client.query_model.return_value = ["[This is not valid YAML"]
        with pytest.raises(YamlConversionError):
            await generator._try_convert_yaml_list(  # noqa: SLF001
    ...
    @pytest.mark.asyncio
    async def test_generate_macro_topics(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_generate_subtopics(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_generate_open_qa_from_topic(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_revise_open_qa(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_generate_writing_tasks(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_revise_writing_tasks(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_generate_closed_qa_instructions(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_gather(self, mock_llm_client: AsyncMock) -> None:
        ...
        async def mock_coro1() -> list[str]:
            return ["Result 1"]

        async def mock_coro2() -> list[str]:
            return ["Result 2"]

        async def mock_coro3() -> list[str]:
            return ["Result 3"]

        # Test gathering results
        requests = [mock_coro1(), mock_coro2(), mock_coro3()]
        results = await generator._gather(requests)  # noqa: SLF001

        # Check that we get all results in the right order
        assert results == [["Result 1"], ["Result 2"], ["Result 3"]]

    @pytest.mark.asyncio
    async def test_generate_math_macro_topics(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_generate_math_subtopics(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_classify_math_entity(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_generate_math_problem(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_generate_python_macro_topics(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_generate_python_subtopics(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_classify_python_entity(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_generate_python_problem(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_impersonate_user(self, mock_llm_client: AsyncMock) -> None:
        ...
        result = await generator._impersonate_user(  # noqa: SLF001
    ...
    @pytest.mark.asyncio
    async def test_generate_dialogue(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_generate_two_turn_prompt(self, mock_llm_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_generate_parse_subtopic(self, mock_llm_client: AsyncMock) -> None:
        """Test the _generate_parse_subtopic helper method."""
        generator = AsyncNemotronGenerator(mock_llm_client)

        # Patch the methods
        with (
            patch.object(AsyncNemotronGenerator, "generate_subtopics", new_callable=AsyncMock) as mock_subtopics,
            patch.object(AsyncNemotronGenerator, "_try_convert_yaml_list", new_callable=AsyncMock) as mock_convert,
        ):
            # Set up return values
            ...
            # Call the method
            result = await generator._generate_parse_subtopic(  # noqa: SLF001
                macro_topic="Science",
                n_subtopics=2,
                model="test_model",
    ...
    @pytest.mark.asyncio
    async def test_generate_parse_openline(self, mock_llm_client: AsyncMock) -> None:
        """Test the _generate_parse_openline helper method."""
        generator = AsyncNemotronGenerator(mock_llm_client)

        # Patch the methods
        with (
            patch.object(AsyncNemotronGenerator, "generate_open_qa_from_topic", new_callable=AsyncMock) as mock_qa,
            patch.object(AsyncNemotronGenerator, "_try_convert_yaml_list", new_callable=AsyncMock) as mock_convert,
        ):
            # Set up return values
            ...
            # Call the method
            result = await generator._generate_parse_openline(  # noqa: SLF001
                subtopic="Physics",
                n_openlines=2,
                model="test_model",
    ...
    @pytest.mark.asyncio
    async def test_run_open_qa_pipeline(self, mock_llm_client: AsyncMock) -> None:
        """Test run_open_qa_pipeline pipeline method."""
        generator = AsyncNemotronGenerator(mock_llm_client)

        # Patch all the required methods
        with (
            patch.object(AsyncNemotronGenerator, "generate_macro_topics", new_callable=AsyncMock) as mock_macro_topics,
            patch.object(
                AsyncNemotronGenerator, "convert_response_to_yaml_list", new_callable=AsyncMock
            ) as mock_convert,
            patch.object(
                AsyncNemotronGenerator, "_generate_parse_subtopic", new_callable=AsyncMock
            ) as mock_parse_subtopic,
            patch.object(
                AsyncNemotronGenerator, "_generate_parse_openline", new_callable=AsyncMock
            ) as mock_parse_openline,
            patch.object(
                AsyncNemotronGenerator, "_revise_parse_openline", new_callable=AsyncMock
            ...
            mock_convert.assert_called_once()
            assert mock_parse_subtopic.call_count == 2  # Called for each macro topic  # noqa: PLR2004
            assert mock_parse_openline.call_count >= 4  # Called at least once for each subtopic  # noqa: PLR2004
            assert mock_revise_openline.call_count >= 8  # Called for each openline item  # noqa: PLR2004

            # Check the result - should have all the revised questions
            assert len(result) >= 8  # At least 2 macro topics x 2 subtopics x 2 questions  # noqa: PLR2004
            assert "Revised" in result[0]  # Verify we're getting the revised questions

    @pytest.mark.asyncio
    async def test_run_writing_pipeline(self, mock_llm_client: AsyncMock) -> None:
        ...
        with (
            patch.object(
                AsyncNemotronGenerator, "_generate_parse_writing_task", new_callable=AsyncMock
            ) as mock_generate_task,
            patch.object(
                AsyncNemotronGenerator, "_revise_parse_writing_task", new_callable=AsyncMock
            ) as mock_revise_task,
        ):
            # Set up return values - use cycle to create infinite iterators for side effects
            ...
            # Check methods were called correctly
            assert mock_generate_task.call_count == 4  # Called for each topic/material type pair  # noqa: PLR2004
            assert mock_revise_task.call_count >= 8  # Called for each task item (2 per generate call)  # noqa: PLR2004

            # Check the result - may have more than 8 items if _revise_parse_writing_task is called more times
            assert len(result) >= 8  # At least 2 topics x 2 material types x 2 tasks  # noqa: PLR2004
            assert "Revised" in result[0]  # Verify we're getting the revised tasks

    @pytest.mark.asyncio
    async def test_run_pipeline_with_yaml_conversion_error(self, mock_llm_client: AsyncMock) -> None:
        ...
        with (
            ...
            patch.object(AsyncNemotronGenerator, "_gather", new_callable=AsyncMock) as mock_gather,
        ):
            ...
            mock_convert.return_value = []  # Return empty list to simulate ignored error
            mock_gather.return_value = []  # Ensure gather also returns empty list
    ...
    @pytest.mark.asyncio
    async def test_revise_parse_openline(self, mock_llm_client: AsyncMock) -> None:
        """Test the _revise_parse_openline helper method."""
        generator = AsyncNemotronGenerator(mock_llm_client)

        # Patch the methods
        with (
            patch.object(AsyncNemotronGenerator, "revise_open_qa", new_callable=AsyncMock) as mock_revise,
            patch.object(AsyncNemotronGenerator, "_try_convert_yaml_list", new_callable=AsyncMock) as mock_convert,
        ):
            # Set up return values
            ...
            # Call the method
            result = await generator._revise_parse_openline(  # noqa: SLF001
    ...
    @pytest.mark.asyncio
    async def test_generate_parse_writing_task(self, mock_llm_client: AsyncMock) -> None:
        """Test the _generate_parse_writing_task helper method."""
        generator = AsyncNemotronGenerator(mock_llm_client)

        # Patch the methods
        with (
            patch.object(AsyncNemotronGenerator, "generate_writing_tasks", new_callable=AsyncMock) as mock_generate,
            patch.object(AsyncNemotronGenerator, "_try_convert_yaml_list", new_callable=AsyncMock) as mock_convert,
        ):
            # Set up return values
            ...
            # Call the method
            result = await generator._generate_parse_writing_task(  # noqa: SLF001
                topic="Science",
                material="Essay",
                n_openlines=2,
                model="test_model",
    ...
    @pytest.mark.asyncio
    async def test_revise_parse_writing_task(self, mock_llm_client: AsyncMock) -> None:
        """Test the _revise_parse_writing_task helper method."""
        generator = AsyncNemotronGenerator(mock_llm_client)

        # Patch the methods
        with (
            patch.object(AsyncNemotronGenerator, "revise_writing_tasks", new_callable=AsyncMock) as mock_revise,
            patch.object(AsyncNemotronGenerator, "_try_convert_yaml_list", new_callable=AsyncMock) as mock_convert,
        ):
            # Set up return values
            mock_revise.return_value = ["Raw revision"]
            ...
            # Call the method
            result = await generator._revise_parse_writing_task(  # noqa: SLF001
                task="Original task",
                n_revisions=2,
                model="test_model",
    ...
    @pytest.mark.asyncio
    async def test_generate_parse_closed_qa(self, mock_llm_client: AsyncMock) -> None:
        ...
        with (
            patch.object(
                AsyncNemotronGenerator, "generate_closed_qa_instructions", new_callable=AsyncMock
            ) as mock_generate,
            patch.object(AsyncNemotronGenerator, "_try_convert_yaml_list", new_callable=AsyncMock) as mock_convert,
        ):
            # Set up return values
            ...
            # Call the method
            result = await generator._generate_parse_closed_qa(  # noqa: SLF001
                document_id=1,
    ...
    @pytest.mark.asyncio
    async def test_run_closed_qa_pipeline(self, mock_llm_client: AsyncMock) -> None:
        """Test run_closed_qa_pipeline pipeline method."""
        generator = AsyncNemotronGenerator(mock_llm_client)

        # Patch the methods
        with (
            patch.object(AsyncNemotronGenerator, "_generate_parse_closed_qa", new_callable=AsyncMock) as mock_parse_qa,
            patch.object(AsyncNemotronGenerator, "_gather", new_callable=AsyncMock) as mock_gather,
        ):
            # Set up return values
            ...
            # Check methods were called correctly
            assert mock_parse_qa.call_count == 2  # Called for each document  # noqa: PLR2004
            mock_gather.assert_called_once()

            # Verify the result format
            assert len(result) == 4  # 2 documents x 2 questions each  # noqa: PLR2004
            assert all(isinstance(item, tuple) for item in result)
            assert result[0][0] == 0  # First document index
            assert result[2][0] == 1  # Second document index

    @pytest.mark.asyncio
    async def test_generate_parse_math_subtopic(self, mock_llm_client: AsyncMock) -> None:
        """Test the _generate_parse_math_subtopic helper method."""
        generator = AsyncNemotronGenerator(mock_llm_client)

        # Patch the methods
        with (
            patch.object(AsyncNemotronGenerator, "generate_math_subtopics", new_callable=AsyncMock) as mock_subtopics,
            patch.object(AsyncNemotronGenerator, "_try_convert_yaml_list", new_callable=AsyncMock) as mock_convert,
        ):
            # Set up return values
            ...
            # Call the method
            result = await generator._generate_parse_math_subtopic(  # noqa: SLF001
    ...
    @pytest.mark.asyncio
    async def test_generate_parse_math_openline(self, mock_llm_client: AsyncMock) -> None:
        """Test the _generate_parse_math_openline helper method."""
        generator = AsyncNemotronGenerator(mock_llm_client)

        # Patch the methods
        with (
            patch.object(AsyncNemotronGenerator, "generate_math_problem", new_callable=AsyncMock) as mock_problem,
            patch.object(AsyncNemotronGenerator, "_try_convert_yaml_list", new_callable=AsyncMock) as mock_convert,
        ):
            # Set up return values
            ...
            # Call the method
            result = await generator._generate_parse_math_openline(  # noqa: SLF001
                subtopic="Algebra",
                n_openlines=2,
                model="test_model",
    ...
    @pytest.mark.asyncio
    async def test_run_math_pipeline(self, mock_llm_client: AsyncMock) -> None:
        ...
        with (
            ...
            patch.object(
                AsyncNemotronGenerator, "_generate_parse_math_subtopic", new_callable=AsyncMock
            ) as mock_parse_subtopic,
            patch.object(
                AsyncNemotronGenerator, "_generate_parse_math_openline", new_callable=AsyncMock
            ) as mock_parse_openline,
            patch.object(AsyncNemotronGenerator, "_gather", new_callable=AsyncMock) as mock_gather,
        ):
            # Set up return values
            ...
            mock_convert.assert_called_once()
            assert mock_gather.call_count >= 2  # noqa: PLR2004

            # Check the result
            assert len(result) == 8  # Should have 8 problems (2 macro x 2 subtopics x 2 problems)  # noqa: PLR2004
            assert all("Problem" in item for item in result)

    @pytest.mark.asyncio
    async def test_generate_parse_python_subtopic(self, mock_llm_client: AsyncMock) -> None:
        ...
        with (
            patch.object(
                AsyncNemotronGenerator, "generate_python_subtopics", new_callable=AsyncMock
            ) as mock_subtopics,
            patch.object(AsyncNemotronGenerator, "_try_convert_yaml_list", new_callable=AsyncMock) as mock_convert,
        ):
            # Set up return values
            ...
            # Call the method
            result = await generator._generate_parse_python_subtopic(  # noqa: SLF001
                macro_topic="Data Structures",
                n_subtopics=2,
                model="test_model",
                subtopic_prompt_template="template",
    ...
    @pytest.mark.asyncio
    async def test_generate_parse_python_openline(self, mock_llm_client: AsyncMock) -> None:
        """Test the _generate_parse_python_openline helper method."""
        generator = AsyncNemotronGenerator(mock_llm_client)

        # Patch the methods
        with (
            patch.object(AsyncNemotronGenerator, "generate_python_problem", new_callable=AsyncMock) as mock_problem,
            patch.object(AsyncNemotronGenerator, "_try_convert_yaml_list", new_callable=AsyncMock) as mock_convert,
        ):
            # Set up return values
            ...
            # Call the method
            result = await generator._generate_parse_python_openline(  # noqa: SLF001
                subtopic="Lists",
                n_openlines=2,
                model="test_model",
    ...
    @pytest.mark.asyncio
    async def test_run_python_pipeline(self, mock_llm_client: AsyncMock) -> None:
        ...
        with (
            patch.object(
                AsyncNemotronGenerator, "generate_python_macro_topics", new_callable=AsyncMock
            ) as mock_macro_topics,
            patch.object(
                AsyncNemotronGenerator, "convert_response_to_yaml_list", new_callable=AsyncMock
            ) as mock_convert,
            patch.object(
                AsyncNemotronGenerator, "_generate_parse_python_subtopic", new_callable=AsyncMock
            ) as mock_parse_subtopic,
            patch.object(
                AsyncNemotronGenerator, "_generate_parse_python_openline", new_callable=AsyncMock
            ) as mock_parse_openline,
            patch.object(AsyncNemotronGenerator, "_gather", new_callable=AsyncMock) as mock_gather,
        ):
            # Set up return values
    ...
    @pytest.mark.asyncio
    async def test_pipeline_error_handling(self, mock_llm_client: AsyncMock) -> None:
