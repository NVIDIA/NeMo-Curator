...
class TestFilterModule:
    ...
    def test_score(self, letter_count_data):
        letter_filter = LetterCountFilter()
        score_field = "a_count"
        score_step = Score(letter_filter.score_document, text_field="documents", score_field=score_field)
    ...
    def test_score_type(self, letter_count_data):
        letter_filter = LetterCountFilter()
        score_field = "a_count"
        score_step = Score(letter_filter.score_document, text_field="documents", score_field=score_field, score_type=int)
        scored_data = score_step(letter_count_data)
...
class TestHeuristicFilters:
    ...
    def test_symbolswords(self):
        dataset = list_to_dataset(["mixed bag ... #", "full of words", "... # ... # #", "barely ok 3 4 5 6 7 8 9 #"])
    ...
    def test_urls(self):
        dataset = list_to_dataset(["https://www.nvidia.com/en-us/", "no urls here!", "$!@$@!$!@", "bunch of other words with url afdsjafidsaofjbwreowihfdsafbdashuoiotauhiofdafdsafd fdasfdafdsafdsafdsafdsafdsafdsa https://www.nvidia.com/en-us/ something else after the url etc more and more", "words with url https://www.nvidia.com/en-us/"])
    ...
    def test_bullets(self):
        dataset = list_to_dataset(["• not good", "good", "50 \n ⦾ 50", "⁌ this \n⁌ should \n⁌barely \n⁌pass \n⁌5 \n⁌6 \n⁌7 \n⁌8 \n⁌9 \n done!"])
    ...
    def test_boilerplate(self):
        dataset = list_to_dataset(["nothing\t here", "1\n\n2\n\n3\n\n4\n\n5\n\n6\n\nterms of use\n\n privacy policy\n\n cookie policy\n\nuses cookies", "too much \n\n privacy & cookies policy"])
    ...
    def test_meanwordlength(self):
        dataset = list_to_dataset(["a", "aa", "superlongword short", "evenly balanced", "waytoolongforasingleword"])
    ...
    def test_repeatingtopngrams(self):
        dataset = list_to_dataset(["this is a totally fine sentence with no repeating ngrams so we are ok", "a b . a b", "a a a a a a", "totally fine small dupe a b a b"])
    ...
    def test_pornographicurls(self):
        dataset = list_to_dataset(["no url", "fine url https://www.nvidia.com/en-us/", "bad url https://www.pornhub.com/"])
...
class TestCodeFilters:
    ...
    def test_per_extension_filter(self):
        ...
        metadata_file = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "nemo_curator", "utils", "code_meta.csv"))
        filters = ScoreFilter(PerExtensionFilter("c++", "cpp", metadata_file=metadata_file))
        filtered_data = filters(dataset)
