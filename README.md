...
You can also install NeMo Curator using the [RAPIDS Nightly Builds](https://anaconda.org/rapidsai-nightly). To do so, you can set the environment variable `RAPIDS_NIGHTLY=1`.
