...
- [Document-level deduplication](docs/user-guide/gpudeduplication.rst)
  ...
  - For semantic deduplication,  our implementation follows the method described in [SemDeDup](https://arxiv.org/pdf/2303.09540) by Meta AI (FAIR) [SemDeDup](https://github.com/facebookresearch/SemDeDup)
